<!-- Modal -->
<div class="modal fade" id="modalFormPenduduk" tabindex="-1" aria-labelledby="modalFormPendudukLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalFormPendudukLabel">Tambah Data Penduduk</h5>
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('penduduk.store') }}" enctype="multipart/form-data">
                    ...
                    <!-- Hidden field for method (PUT or POST) -->
                    <div id="method"></div>
            </div>
